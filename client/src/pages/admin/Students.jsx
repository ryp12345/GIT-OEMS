						...
						<div className="relative sm:col-span-2 xl:col-span-1">
							...
							<div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:items-center sm:gap-3">
								<button
									...
									className="rounded bg-emerald-600 px-3 py-1.5 text-xs font-medium text-white shadow hover:bg-emerald-700 disabled:opacity-50 flex items-center"
								>
								...
								<form onSubmit={handleImportSubmit} className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:items-center sm:gap-2">
									<input
										ref={importInputRef}
										type="file"
										accept=".csv,.xlsx,.xls"
										onChange={handleImportFileChange}
										className="block w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-700 sm:w-48"
									/>
									<button
										type="submit"
										disabled={isImporting}
										className="rounded bg-amber-500 px-3 py-1.5 text-xs font-medium text-white shadow hover:bg-amber-600 disabled:opacity-50 flex items-center"
									>
										<svg xmlns="http://www.w3.org/2000/svg" className="mr-2 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
								...
								<button
									...
									className="rounded bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow hover:bg-blue-700 disabled:opacity-50 flex items-center w-full sm:w-auto"
								>
									<svg xmlns="http://www.w3.org/2000/svg" className="mr-2 h-4 w-4" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" clipRule="evenodd" /></svg>
